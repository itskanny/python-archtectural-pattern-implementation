...
class TeacherController:
    ...
    def __init__(self, id):
        unclean_data = Database().get_by_id("teacher", id)
...
if __name__ == "__main__":
    ...
    if len(config_data) == 2 and config_data.keys().__contains__("id") and config_data.keys().__contains__("message"):
        TeacherController(config_data['id']).notify(config_data['message'])
    else:
